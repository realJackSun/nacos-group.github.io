...
Nacos是阿里巴巴开源的服务发现与配置管理项目，本次发布的2.0.1版本，主要致力于支持MCP-OVER-XDS协议。
本次发布的1.4.2版本，极大增强JRaft集群Leader选举的稳定性。

## Nacos 2.0.1

2.0.1主要变更为：

1. 主要修复了Jraft协议在k8s环境中的Leader选举的稳定性。
2. 并修复了k8s环境下，频繁抛出Server is Down错误的问题。
3. 与Istio进行功能对接，在nacos-istio插件及模块中，支持MCP-OVER-XDS协议。
...
该版本主要优化了JRaft协议中Leader选举的稳定性，与最新的nacos-k8s项目配合使用，可以在很大程度上优化稳定性。
而且，该版本了修复有关“Server is Down”问题的提示及众多1.4.1版本中的Bug。
...
随着Nacos 2.0.1及1.4.2的发布， Nacos社区又新增了两位Committer：MajorHe1和JackSun-Developer。两位同学在修复JRaft稳定性、增大单元测试覆盖率、修复集成测试等内容中作出许多贡献，并积极参与社区讨论。
...
Nacos社区将参与中科大编程之夏活动，欢迎学生参与活动，共建Nacos社区，学生指南
